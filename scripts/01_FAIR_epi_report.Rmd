...
stand_method
```
The internal authority lists are used in combination with the EAGLE vocabularies in its original and modified form. Majority of projects (`r stand_method$ratio[1]`%) uses only one method to record their standards, while `r sum(stand_method$ratio[2:3])`% of projects use a combination of two or three methods.
